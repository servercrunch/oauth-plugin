...
module Haml
  module Generators
    class OauthProviderGenerator < Erb::Generators::Base
      ...
      def copy_view_files
        template '_form.html.haml',              File.join('app/views', class_path, 'oauth_applications', '_form.html.haml')
        template 'new.html.haml',                File.join('app/views', class_path, 'oauth_applications', 'new.html.haml')
        template 'index.html.haml',              File.join('app/views', class_path, 'oauth_applications', 'index.html.haml')
        template 'show.html.haml',               File.join('app/views', class_path, 'oauth_applications', 'show.html.haml')
        template 'edit.html.haml',               File.join('app/views', class_path, 'oauth_applications', 'edit.html.haml')
